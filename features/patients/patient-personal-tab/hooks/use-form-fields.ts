 ...
 */
export function usePersonalFields(): Omit<
  PersonalFieldDefinition,
  "value" | "error"
>[] {
  ...
  const fields = useMemo(
    (): Omit<PersonalFieldDefinition, "value" | "error">[] => {
      ...
      const educationLevelOptions = [
        ...
        {
          value: "POSTGRADUATE",
          label: tOptions("educationLevelPostgraduate"),
        },
      ];
      ...
      const employmentStatusOptions = [
        ...
        {
          value: "SELF_EMPLOYED",
          label: tOptions("employmentStatusSelfEmployed"),
        },
      ...
      const livingArrangementOptions = [
        {
          value: "LIVING_ALONE",
          label: tOptions("livingArrangementLivingAlone"),
        },
        {
          value: "LIVING_WITH_PARTNER",
          label: tOptions("livingArrangementLivingWithPartner"),
        },
        {
          value: "LIVING_WITH_FAMILY",
          label: tOptions("livingArrangementLivingWithFamily"),
        },
        {
          value: "STATIONARY_CARE",
          label: tOptions("livingArrangementStationaryCare"),
        },
      ...
      return [
        ...
        },
        {
          ...
          placeholder: tFields("employerPlaceholder"),
          group: "professional",
        },
      ];
    },
