alter table "public"."company_info" add column "city_id" bigint;

alter table "public"."company_info" add column "country_id" smallint;

alter table "public"."company_info" add column "registration_number" character varying(50);

alter table "public"."company_info" add constraint "company_info_city_id_fkey" FOREIGN KEY (city_id) REFERENCES public.cities(id) not valid;

alter table "public"."company_info" validate constraint "company_info_city_id_fkey";

alter table "public"."company_info" add constraint "company_info_country_id_fkey" FOREIGN KEY (country_id) REFERENCES public.countries(id) not valid;

alter table "public"."company_info" validate constraint "company_info_country_id_fkey";
