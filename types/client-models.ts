...
export type PatientGeneralClientModel = Omit<PatientGeneralModel, "date_of_birth"> & {
  date_of_birth: Date | null;
};

export type PatientIdDocumentClientModel = Omit<PatientIdDocumentModel, "issue_date" | "expiry_date" | "documentTypeTranslations"> & {
  documentTypeTranslations: Record<string, string> | null;
  issue_date: Date | null;
  expiry_date: Date | null;
};

export type PatientInsuranceClientModel = Omit<PatientInsuranceModel, "effective_date" | "expiry_date"> & {
  effective_date: Date;
  expiry_date: Date | null;
};

export type FullPatientClientModel = Omit<FullPatientDataModel, "general" | "id_documents" | "insurances"> & {
...
export type MedicalHistoryDocumentClientModel = Omit<
  MedicalHistoryDocumentModel,
...
export type MedicalHistoryEventClientModel = Omit<
  MedicalHistoryEventModel,
  "event_date" | "documents" | "diagnoses"
> & {
  event_date: Date;
