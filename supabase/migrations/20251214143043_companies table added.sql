...
alter table "public"."companies" add constraint "companies_city_id_fkey" FOREIGN KEY (city_id) REFERENCES public.cities(id) not valid;

alter table "public"."companies" validate constraint "companies_city_id_fkey";

alter table "public"."companies" add constraint "companies_country_id_fkey" FOREIGN KEY (country_id) REFERENCES public.countries(id) not valid;

alter table "public"."companies" validate constraint "companies_country_id_fkey";
...
alter table "public"."companies" add constraint "companies_discount_percentage_check" CHECK (((discount_percentage >= (0)::numeric) AND (discount_percentage <= (100)::numeric))) not valid;

alter table "public"."companies" validate constraint "companies_discount_percentage_check";
